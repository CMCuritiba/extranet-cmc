...
2. Go to your repository at [cmcuritiba/extranet-cmc](https://github.com/cmcuritiba/extranet-cmc).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `extranet.curitiba.pr.leg.br` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | extranet.curitiba.pr.leg.br | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | extranet.curitiba.pr.leg.br |
...
- [Backend Tests Workflow](https://github.com/cmcuritiba/extranet-cmc/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/cmcuritiba/extranet-cmc/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/cmcuritiba/extranet-cmc-backend`) and Frontend (`ghcr.io/cmcuritiba/extranet-cmc-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of extranet.curitiba.pr.leg.br](https://github.com/cmcuritiba/extranet-cmc/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/extranet.curitiba.pr.leg.br.yml` stack.
