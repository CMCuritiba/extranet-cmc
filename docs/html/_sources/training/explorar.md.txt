...
O outro botão de ação é o botão de conteúdo, clique no botão de conteúdo para exibir os ítens que estão na pasta. No caso do exemplo só existe uma pasta de imagens que chama `Images`. Para voltar basta clicar no botão com a seta para esquerda.
