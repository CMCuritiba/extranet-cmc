...
// https://www.curitiba.pr.leg.br/portal_javascripts/register_function.js?original=1
var bugRiddenCrashPronePieceOfJunk=(navigator.userAgent.indexOf('MSIE 5')!==-1&&navigator.userAgent.indexOf('Mac')!==-1);var W3CDOM=(!bugRiddenCrashPronePieceOfJunk&&typeof document.getElementsByTagName!=='undefined'&&typeof document.createElement!=='undefined');var registerEventListener=function(elem,event,func){jQuery(elem).bind(event,func)};var unRegisterEventListener=function(elem,event,func){jQuery(elem).unbind(event,func)};var registerPloneFunction=jQuery;
function getContentArea(){var node=jQuery('#region-content,#content');return node.length?node[0]:null}


/* - plone_javascript_variables.js - */
// https://www.curitiba.pr.leg.br/portal_javascripts/plone_javascript_variables.js?original=1
var portal_url='https://www.curitiba.pr.leg.br';var form_modified_message='O seu formulário não foi salvo. Todas as alterações serão perdidas.';var form_resubmit_message='Você já clicou no botão de envio. Você realmente quer enviar este formulário novamente?';var external_links_open_new_window='true';var mark_special_links='false';var ajax_noresponse_message='Nenhuma resposta do servidor. Por favore, tente mais tarde.';
...
// https://www.curitiba.pr.leg.br/portal_javascripts/++resource++plone.app.jquerytools.overlayhelpers.js?original=1
...
/* - nodeutilities.js - */
// https://www.curitiba.pr.leg.br/portal_javascripts/nodeutilities.js?original=1
...
/* - cookie_functions.js - */
// https://www.curitiba.pr.leg.br/portal_javascripts/cookie_functions.js?original=1
...
/* - modernizr.js - */
// https://www.curitiba.pr.leg.br/portal_javascripts/modernizr.js?original=1
...
/* - livesearch.js - */
// https://www.curitiba.pr.leg.br/portal_javascripts/livesearch.js?original=1
...
/* - ++resource++search.js - */
// https://www.curitiba.pr.leg.br/portal_javascripts/++resource++search.js?original=1
...
/* - select_all.js - */
// https://www.curitiba.pr.leg.br/portal_javascripts/select_all.js?original=1
...
/* - dragdropreorder.js - */
// https://www.curitiba.pr.leg.br/portal_javascripts/dragdropreorder.js?original=1
...
// https://www.curitiba.pr.leg.br/portal_javascripts/mark_special_links.js?original=1
...
// https://www.curitiba.pr.leg.br/portal_javascripts/collapsiblesections.js?original=1
...
/* - form_tabbing.js - */
// https://www.curitiba.pr.leg.br/portal_javascripts/form_tabbing.js?original=1
...
/* - popupforms.js - */
// https://www.curitiba.pr.leg.br/portal_javascripts/popupforms.js?original=1
...
// https://www.curitiba.pr.leg.br/portal_javascripts/jquery.highlightsearchterms.js?original=1
...
// https://www.curitiba.pr.leg.br/portal_javascripts/first_input_focus.js?original=1
jQuery(function($){if($("form div.error :input:first").focus().length){return}
$("form.enableAutoFocus :input:not(.formTabs):visible:first").focus()});

/* - accessibility.js - */
// https://www.curitiba.pr.leg.br/portal_javascripts/accessibility.js?original=1
...
/* - styleswitcher.js - */
// https://www.curitiba.pr.leg.br/portal_javascripts/styleswitcher.js?original=1
...
/* - toc.js - */
// https://www.curitiba.pr.leg.br/portal_javascripts/toc.js?original=1
...
// https://www.curitiba.pr.leg.br/portal_javascripts/collapsibleformfields.js?original=1
...
// https://www.curitiba.pr.leg.br/portal_javascripts/++resource++plone.app.discussion.javascripts/comments.js?original=1
...
/* - dropdown.js - */
// https://www.curitiba.pr.leg.br/portal_javascripts/dropdown.js?original=1
...
// https://www.curitiba.pr.leg.br/portal_javascripts/inline_validation.js?original=1
...
/* - kss-bbb.js - */
// https://www.curitiba.pr.leg.br/portal_javascripts/kss-bbb.js?original=1
(function($){
