from extranetcmcuritibaprlegbr import logger
from extranetcmcuritibaprlegbr.setuphandlers import content
from extranetcmcuritibaprlegbr.setuphandlers import users
...
class HiddenProfiles(object):
    def getNonInstallableProfiles(self):
        ...
        return [
            "extranetcmcuritibaprlegbr:uninstall",
        ]
